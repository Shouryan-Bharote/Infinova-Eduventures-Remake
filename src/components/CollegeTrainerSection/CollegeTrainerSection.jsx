...
import './CollegeTrainerSection.css';

const CollegeTrainersSection = () => {
  const trainers = [
    {
  ...
  return (
    <section className="college-trainers-section">
      <div className="college-trainer-section-header">
        <h2 className="college-trainer-section-title">
          Our Industry Experts Trainers
        </h2>
        <p className="college-trainer-section-description">
...
export default CollegeTrainersSection;
